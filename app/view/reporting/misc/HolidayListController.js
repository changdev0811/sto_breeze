/**
 * View Controller for Misc Holiday List reporting criteria view
 * @class HolidayListController
 * @namespace Breeze.view.reporting.misc.HolidayListController
 * @alias controller.reporting.misc.holidaylist
 */
Ext.define('Breeze.view.reporting.misc.HolidayListController', {
    ...
    onInit: function (component) {
        ...
        console.info('Misc Holiday List Report view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.misc.HolidayList',
