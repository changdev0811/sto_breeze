/**
 * View Controller for Misc Perfect Attendance reporting criteria view
 * @class AttendanceController
 * @namespace Breeze.view.reporting.misc.AttendanceController
 * @alias controller.reporting.misc.attendance
 */
Ext.define('Breeze.view.reporting.misc.AttendanceController', {
    ...
    onInit: function (component) {
        ...
        console.info('Misc Perfect Attendance view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.misc.Attendance',
