/**
 * Misc Leave Request Summary Report form
 * @class LeaveRequestSummary
 * @namespace Breeze.view.reporting.misc.LeaveRequestSummary
 * @alias widget.reporting.misc.leaverequestsummary
 */
Ext.define('Breeze.view.reporting.misc.LeaveRequestSummary', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.misc.leaverequestsummary',

    config: {
        crumbTitle: 'Leave Request Summary Report',
    },

    // View Model
    viewModel: {
        type: 'reporting.misc.leaverequestsummary'
    },
    
    // Controller
    controller: 'reporting.misc.leaverequestsummary',
    ...
    title: 'Leave Request Summary Report',
