/**
 * Misc Department List Report form
 * @class DepartmentList
 * @namespace Breeze.view.reporting.misc.DepartmentList
 * @alias widget.reporting.misc.departmentlist
 */
Ext.define('Breeze.view.reporting.misc.DepartmentList', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.misc.departmentlist',

    config: {
        crumbTitle: 'Department List Report',
    },

    // View Model
    viewModel: {
        type: 'reporting.misc.departmentlist'
    },
    
    // Controller
    controller: 'reporting.misc.departmentlist',
