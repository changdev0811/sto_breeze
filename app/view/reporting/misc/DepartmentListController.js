/**
 * View Controller for Misc Department List reporting criteria view
 * @class DepartmentListController
 * @namespace Breeze.view.reporting.misc.DepartmentListController
 * @alias controller.reporting.misc.departmentlist
 */
Ext.define('Breeze.view.reporting.misc.DepartmentListController', {
    ...
    onInit: function (component) {
        ...
        console.info('Misc Department List Report view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.misc.DepartmentList',
    ...
    refreshSelectedItems: function(){
        var vm = this.getViewModel(),
            employeeSelectTree = this.lookup('departments');
