/**
 * View Model class for Department QuickList reporting view
 * @class QuickListModel
 * @namespace Breeze.view.reporting.misc.QuickListModel
 * @alias viewmodel.reporting.misc.quicklist
 */
Ext.define('Breeze.view.reporting.misc.QuickListModel', {
