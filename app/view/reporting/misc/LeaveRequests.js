/**
 * Misc Leave Requests Report form
 * @class LeaveRequests
 * @namespace Breeze.view.reporting.misc.LeaveRequests
 * @alias widget.reporting.misc.leaverequests
 */
Ext.define('Breeze.view.reporting.misc.LeaveRequests', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.misc.leaverequests',

    config: {
        crumbTitle: 'Leave Requests Report',
    },
