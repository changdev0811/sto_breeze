/**
 * View Controller for Misc Leave Request Summary reporting criteria view
 * @class LeaveRequestSummaryController
 * @namespace Breeze.view.reporting.misc.LeaveRequestSummaryController
 * @alias controller.reporting.misc.leaverequestsummary
 */
Ext.define('Breeze.view.reporting.misc.LeaveRequestSummaryController', {
    ...
    onInit: function (component) {
        ...
        console.info('Misc Leave Request Summary view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.misc.LeaveRequestSummary',
