/**
 * Misc Holiday Reconciliation Report form
 * @class HolidayReconciliation
 * @namespace Breeze.view.reporting.misc.HolidayReconciliation
 * @alias widget.reporting.misc.holidayreconciliation
 */
Ext.define('Breeze.view.reporting.misc.HolidayReconciliation', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.misc.holidayreconciliation',

    config: {
        crumbTitle: 'Holiday Reconciliation Report',
    },

    // View Model
    viewModel: {
        type: 'reporting.misc.holidayreconciliation'
    },
    
    // Controller
    controller: 'reporting.misc.holidayreconciliation',
    ...
    title: 'Holiday Reconciliation Report',
