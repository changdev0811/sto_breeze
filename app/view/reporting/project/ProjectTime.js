/**
 * Project Time Summary Report form
 * @class ProjectTime
 * @namespace Breeze.view.reporting.project.ProjectTime
 * @alias widget.reporting.project.projecttime
 */
Ext.define('Breeze.view.reporting.project.ProjectTime', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.project.projecttime',
    ...
    // Controller
    controller: 'reporting.project.projecttime',
    ...
    title: 'Project Time Summary Report',
