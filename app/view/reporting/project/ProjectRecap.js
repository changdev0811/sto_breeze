/**
 * Project Recap Report form
 * @class ProjectRecap
 * @namespace Breeze.view.reporting.project.ProjectRecap
 * @alias widget.reporting.project.projectrecap
 */
Ext.define('Breeze.view.reporting.project.ProjectRecap', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.project.projectrecap',
    ...
    // Controller
    controller: 'reporting.project.projectrecap',
