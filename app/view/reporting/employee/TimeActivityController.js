/**
 * View Controller for Employee Time Activity reporting criteria view
 * @class TimeActivityController
 * @namespace Breeze.view.reporting.employee.TimeActivityController
 * @alias controller.reporting.employee.timeactivity
 */
Ext.define('Breeze.view.reporting.employee.TimeActivityController', {
    ...
    onInit: function (component) {
        ...
        console.info('Employee Time Activity Report view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.employee.TimeActivity',
