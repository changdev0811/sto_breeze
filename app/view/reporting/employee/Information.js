 ...
 */
Ext.define('Breeze.view.reporting.employee.Information', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.employee.information',

    config: {
        crumbTitle: 'Employee Information Report',
    },

    // View Model
    viewModel: {
        type: 'reporting.employee.information'
    },
    
    // Controller
    controller: 'reporting.employee.information',
                            ...
                            items: [
                                {
                                    ...
                                    inline: true,
                                    label: '',
                                    boxLabel: 'Show Employee SSN',
                                    bind: '{reportParams.viewssn}'
                                },
                                {
                                    name: 'ShowComp',
                                    label: '',
                                    labelMinWidth: 0,
                                    boxLabel: 'Show Employee Compensation',
                                    bind: '{reportParams.viewcomp}'
                                },
                                {
                                    name: 'ShowSuper',
                                    label: '',
                                    boxLabel: 'Show Employee Supervisors',
                                    bind: '{reportParams.viewsuper}'
                                }
                            ]
                        }
                    ]
