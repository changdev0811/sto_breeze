/**
 * View Controller for Employee FYI Report reporting criteria view
 * @class FyiController
 * @namespace Breeze.view.reporting.employee.Fyi
 * @alias controller.reporting.employee.fyi
 */
Ext.define('Breeze.view.reporting.employee.FyiController', {
    ...
    onInit: function (component) {
        ...
        console.info('Employee FYI Report view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.employee.Fyi',
