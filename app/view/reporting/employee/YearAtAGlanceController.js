/**
 * View Controller for Employee Year At A Glance Report reporting criteria view
 * @class YearAtAGlanceController
 * @namespace Breeze.view.reporting.employee.YearAtAGlance
 * @alias controller.reporting.employee.yearataglance
 */
Ext.define('Breeze.view.reporting.employee.YearAtAGlanceController', {
    ...
    onInit: function (component) {
        ...
        console.info('Employee Year At A Glance Report view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.employee.YearAtAGlance',
