/**
 * View Controller for Employee Worktime Details reporting criteria view
 * @class WorktimeDetailsController
 * @namespace Breeze.view.reporting.employee.WorktimeDetailsController
 * @alias controller.reporting.employee.worktimedetails
 */
Ext.define('Breeze.view.reporting.employee.WorktimeDetailsController', {
    ...
    onInit: function (component) {
        ...
        console.info('Employee Worktime Details Report view inited');
