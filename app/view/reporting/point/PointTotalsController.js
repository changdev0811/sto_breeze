/**
 * View Controller for Point Totals reporting criteria view
 * @class PointTotalsController
 * @namespace Breeze.view.reporting.point.PointTotalsController
 * @alias controller.reporting.point.pointtotals
 */
Ext.define('Breeze.view.reporting.point.PointTotalsController', {
    ...
    onInit: function (component) {
        ...
        console.info('Point Totals Report view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.point.PointTotals',
