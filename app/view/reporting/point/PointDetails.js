/**
 * Point Details Report form
 * @class PointDetails
 * @namespace Breeze.view.reporting.point.PointDetails
 * @alias widget.reporting.point.pointdetails
 */
Ext.define('Breeze.view.reporting.point.PointDetails', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.point.pointdetails',

    config: {
        crumbTitle: 'Point Details Report',
    },

    // View Model
    viewModel: {
        type: 'reporting.point.pointdetails'
    },
    
    // Controller
    controller: 'reporting.point.pointdetails',
