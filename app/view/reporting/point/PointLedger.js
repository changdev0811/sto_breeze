/**
 * Point Ledger Report form
 * @class PointLedger
 * @namespace Breeze.view.reporting.point.PointLedger
 * @alias widget.reporting.point.pointledger
 */
Ext.define('Breeze.view.reporting.point.PointLedger', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.point.pointledger',
    ...
    // Controller
    controller: 'reporting.point.pointledger',
