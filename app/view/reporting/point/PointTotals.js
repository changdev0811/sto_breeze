/**
 * Point Totals Report form
 * @class PointTotals
 * @namespace Breeze.view.reporting.point.PointTotals
 * @alias widget.reporting.point.pointtotals
 */
Ext.define('Breeze.view.reporting.point.PointTotals', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.point.pointtotals',
    ...
    // Controller
    controller: 'reporting.point.pointtotals',
