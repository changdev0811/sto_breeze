/**
 * Department Monthly Report form
 * @class Monthly
 * @namespace Breeze.view.reporting.department.Monthly
 * @alias widget.reporting.department.monthly
 */
Ext.define('Breeze.view.reporting.department.Monthly', {
    extend: 'Ext.Panel',
    alias: 'widget.reporting.department.monthly',

    config: {
        crumbTitle: 'Monthly Report',
    },
