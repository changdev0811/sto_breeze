/**
 * View Controller for Department Security Report reporting criteria view
 * @class SecurityController
 * @namespace Breeze.view.reporting.department.Security
 * @alias controller.reporting.department.security
 */
Ext.define('Breeze.view.reporting.department.SecurityController', {
    ...
    onInit: function (component) {
        ...
        console.info('Department Security view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.department.Security',
