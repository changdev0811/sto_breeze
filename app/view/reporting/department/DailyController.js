/**
 * View Controller for Department Daily Report reporting criteria view
...
Ext.define('Breeze.view.reporting.department.DailyController', {
    ...
    onInit: function (component) {
        ...
        console.info('Department Daily Report view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.department.Daily',
