/**
 * View Controller for Department Summary by Project reporting criteria view
 * @class SummaryProjectController
 * @namespace Breeze.view.reporting.department.SummaryProjectController
 * @alias controller.reporting.department.summaryproject
 */
Ext.define('Breeze.view.reporting.department.SummaryProjectController', {
    ...
    onInit: function (component) {
        ...
        console.info('Department Summary by Project Report view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.department.SummaryProject',
