/**
 * View Controller for Department In/Out History reporting criteria view
 * @class InOutHistoryController
 * @namespace Breeze.view.reporting.department.InOutHistoryController
 * @alias controller.reporting.department.inouthistory
 */
Ext.define('Breeze.view.reporting.department.InOutHistoryController', {
    ...
    onInit: function (component) {
        ...
        console.info('Department In/Out History Report view inited');
        ...
        this.reportApi = Ext.create(
            'Breeze.api.reporting.department.InOutHistory',
