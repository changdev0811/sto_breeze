/**
 * Report handler for Employee's Recorded Time report
 * @class RecordedTime
 * @namespace Breeze.api.reporting.employee.RecordedTime
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.employee.RecordedTime', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'EmployeeRecordedTime'
    },
