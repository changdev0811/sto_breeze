/**
 * Report handler for Employee's Time Activity report
 * @class TimeActivity
 * @namespace Breeze.api.reporting.employee.TimeActivity
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.employee.TimeActivity', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'EmployeeTimeActivity'
    },
