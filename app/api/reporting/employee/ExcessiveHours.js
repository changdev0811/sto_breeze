/**
 * Report handler for Employee's Excessive Hours report
 * @class ExcessiveHours
 * @namespace Breeze.api.reporting.employee.ExcessiveHours
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.employee.ExcessiveHours', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'EmployeeExcessiveHours'
    },
