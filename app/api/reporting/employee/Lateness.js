/**
 * Report handler for Employee's Lateness Check report
 * @class Lateness
 * @namespace Breeze.api.reporting.employee.Lateness
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.employee.Lateness', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'EmployeeLateness'
    },
