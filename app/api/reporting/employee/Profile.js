/**
 * Report handler for Employee's Employee Profile report
 * @class Profile
 * @namespace Breeze.api.reporting.employee.Profile
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.employee.Profile', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'EmployeeProfile'
    },
