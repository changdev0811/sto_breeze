/**
 * Report handler for Employee's Timesheet report
 * @class Timesheet
 * @namespace Breeze.api.reporting.employee.Timesheet
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.employee.Timesheet', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'EmployeeTimesheet'
    },
