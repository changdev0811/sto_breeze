/**
 * Report handler for Employee's Allowance Projection report
 * @class Allowance
 * @namespace Breeze.api.reporting.employee.Allowance
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.employee.Allowance', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'EmployeeAllowanceProjection'
    },
