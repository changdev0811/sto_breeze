/**
 * Report handler for Department's Time Recap report
 * @class TimeRecap
 * @namespace Breeze.api.reporting.department.TimeRecap
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.TimeRecap', {
    ...
    generate: function(cfg, modelParamsData, format){
        ...
        this.appendParam(params, 'userId', cust);
