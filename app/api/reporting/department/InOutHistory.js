/**
 * Report handler for Department's InOut History report
 * @class InOutHistory
 * @namespace Breeze.api.reporting.department.InOutHistory
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.InOutHistory', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'DepartmentInOutHistory'
    },
