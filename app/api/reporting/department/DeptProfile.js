/**
 * Report handler for Department's Department Profile report
 * @class DeptProfile
 * @namespace Breeze.api.reporting.department.DeptProfile
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.DeptProfile', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'DepartmentProfile'
    },
