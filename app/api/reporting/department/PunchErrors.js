/**
 * Report handler for Department's Punch Errors report
 * @class PunchErrors
 * @namespace Breeze.api.reporting.department.PunchErrors
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.PunchErrors', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'DepartmentPunchErrors'
    },
