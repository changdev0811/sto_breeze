/**
 * Report handler for Department's Department Project Summary report
 * @class DeptProject
 * @namespace Breeze.api.reporting.department.DeptProject
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.DeptProject', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'DepartmentProjectSummary'
    },
