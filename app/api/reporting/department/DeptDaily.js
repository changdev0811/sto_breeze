/**
 * Report handler for Department's Department Daily report
 * @class DeptDaily
 * @namespace Breeze.api.reporting.department.DeptDaily
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.DeptDaily', {
