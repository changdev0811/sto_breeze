/**
 * Report handler for Department Overtime Check report
 * @class Overtime
 * @namespace Breeze.api.reporting.department.Overtime
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.Overtime', {
