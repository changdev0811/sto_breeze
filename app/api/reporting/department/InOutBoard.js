/**
 * Report handler for Department's InOut Board report
 * @class InOutBoard
 * @namespace Breeze.api.reporting.department.InOutBoard
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.InOutBoard', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'DepartmentInOutBoard'
    },
