/**
 * Report handler for Department Adjustment report
 * @class Adjustment
 * @namespace Breeze.api.reporting.department.Adjustment
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.Adjustment', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'DepartmentAdjustments'
    },
