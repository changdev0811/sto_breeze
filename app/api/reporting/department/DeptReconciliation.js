/**
 * Report handler for Department's Department Reconciliation report
 * @class DeptReconciliation
 * @namespace Breeze.api.reporting.department.DeptReconciliation
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.DeptReconciliation', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'DepartmentReconciliation'
    },
