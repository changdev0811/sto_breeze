/**
 * Report handler for Department Absence Summary report
 * @class AbsenceSummary
 * @namespace Breeze.api.reporting.department.AbsenceSummary
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.AbsenceSummary', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'DepartmentAbsenceSummary'
    },
