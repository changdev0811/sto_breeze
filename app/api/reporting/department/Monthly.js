/**
 * Report handler for Department Monthly report
 * @class Monthly
 * @namespace Breeze.api.reporting.department.Monthly
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.department.Monthly', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'DepartmentMonthly'
    },
