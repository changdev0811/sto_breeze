/**
 * Report handler for Misc. Perfect Attendance report
 * @class Attendance
 * @namespace Breeze.api.reporting.misc.Attendance
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.misc.Attendance', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'MiscPerfectAttendance'
    },
