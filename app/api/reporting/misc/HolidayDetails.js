/**
* Report handler for Misc. Holiday Details report
* @class HolidayDetails
* @namespace Breeze.api.reporting.misc.HolidayDetails
* @extends Breeze.api.reporting.Base
*/
Ext.define('Breeze.api.reporting.misc.HolidayDetails', {
   extend: 'Breeze.api.reporting.Base',
   
   statics: {
       ajaxCall: '',
       report: 'MiscHolidayDetails'
   },
