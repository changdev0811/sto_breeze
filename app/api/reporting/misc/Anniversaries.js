/**
 * Report handler for Misc Anniversary List report
 * @class Anniversaries
 * @namespace Breeze.api.reporting.misc.Anniversaries
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.misc.Anniversaries', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'MiscAnniversaryList'
    },
