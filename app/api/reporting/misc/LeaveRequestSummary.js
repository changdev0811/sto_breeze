/**
 * Report handler for Misc. Leave Request Summary report
 * @class LeaveRequestSummary
 * @namespace Breeze.api.reporting.misc.LeaveRequestSummary
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.misc.LeaveRequestSummary', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'MiscLeaveRequestSummary'
    },
