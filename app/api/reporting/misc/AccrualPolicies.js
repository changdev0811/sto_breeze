/**
 * Report handler for Misc Accrual Policies report
 * @class AccrualPolicies
 * @namespace Breeze.api.reporting.misc.AccrualPolicies
 * @extends Breeze.api.reporting.Base
 */
Ext.define('Breeze.api.reporting.misc.AccrualPolicies', {
    extend: 'Breeze.api.reporting.Base',
    
    statics: {
        ajaxCall: '',
        report: 'MiscAccrualPolicies'
    },
